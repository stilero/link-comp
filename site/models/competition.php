...
/**
 * LinkcontestModelCompetition
 * @author $Author$
 */
 
 
class LinkcontestModelCompetition  extends JModelItem { 

	
	
	protected $context = 'com_linkcontest.competition';   
	/**
	...
	public function populateState()
	{
		...
		$this->setState('competition.id', $id);
	...
	protected function getStoreId($id = '')
	{
		...
		$id	.= ':'.$this->getState('competition.id');
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Competition', 'Table');
