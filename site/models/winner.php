...
class LinkcontestModelWinner  extends JModelItem { 

	
	
	protected $context = 'com_linkcontest.winner';   
	/**
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Winner', 'Table');
